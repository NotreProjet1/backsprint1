...
const modifierParticipant = async (req, res) => {
    try {
        ...
        const {nom, prenom, domaine, categorie, emailP, mots_de_passeP, tel} = req.body;

        if (!nom || !prenom || !domaine || !emailP || !categorie || !tel || !mots_de_passeP) {
...
module.exports = {
    ...
    updatePassword,
    resetPassword ,
    resetPasswordRequest , getParticipantById
